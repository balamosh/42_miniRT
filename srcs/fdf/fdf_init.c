...
/*   Updated: 2022/08/14 10:04:31 by sotherys         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	cylinder->bot = (t_plane){cylinder->pos, vec3_scale(-1, cylinder->axis)};
	cylinder->top = (t_plane){vec3_sum2(cylinder->pos, vec3_scale(cylinder->height, cylinder->axis)), cylinder->axis};
}
...
t_bool	ft_fdf_init(t_fdf *tab)
{
	...
	tab->test_cylinder[0].radius = 1;
	tab->test_cylinder[0].height = 1.5;
